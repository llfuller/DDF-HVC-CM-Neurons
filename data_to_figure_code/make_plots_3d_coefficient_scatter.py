...
def plot_time_delay_center_values_given_3D_scatter_file(file_name, columns_tuple=(0,1,2)):
...
if __name__ == "__main__":
    ...
    plot_time_delay_center_values_given_3D_scatter_file("3D_Centers(500)_Red171_Neuron1_Epoch1_good_subthreshold_1.txt")
    plot_time_delay_center_values_given_3D_scatter_file("3D_Centers(500)_Red171_Neuron1_Epoch1_poor_subthreshold_1.txt")
    plot_time_delay_center_values_given_3D_scatter_file("3D_Centers(500+1000)_Red171_Neuron1_Epoch1_more_spread_out.txt")