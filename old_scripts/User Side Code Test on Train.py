...
# Voltage_test = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-00014_voltage.txt')
# Current_test = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-00014_current.txt')

#neuron 57 from 2016 (HVC_x)
use_neuron_index = 1
# episode 24
length = 80000
Voltage_train = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-00024_voltage.txt')
Current_train = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-00024_current.txt')
Voltage_test = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-00024_voltage.txt')
Current_test = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-00024_current.txt')
...
# Voltage_test = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-0001_voltage.txt')
# Current_test = np.loadtxt(directories_list[use_neuron_index]+'nidaq_Dev1_ai-0001_current.txt')
...
for tau in range(2,10):
    for D in range(2,10):
        ...
        Pdata = Voltage_test
        PreLength = 140000
        beta_arr,R_arr = [10e-9,10e-8,10e-7,10e-6,10e-5,10e-4,10e-3,10e-2,10e-1],[10e-9,10e-8,10e-7,10e-6,10e-5,10e-4,10e-3,10e-2,10e-1]#[10e-4,10e-3,10e-2,10e-1,10e0,10e1,10e2],[10e-4,10e-3,10e-2,10e-1,10e0,10e1,10e2]#,[10e-3,10e-2,10e-1,10e0,10e1,10e2,10e3]
