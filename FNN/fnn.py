...
def run_this(filepath = "../Data2022-50KhZ/7-7-2022/Lilac 114/Neuron 1/epoch_1.txt"):
    ...
    datasets, time_delay_indices, time_delay_datapairs = generate_min_dist_datasets(filepath, tau, R_ratio, D_arr, search_window_size, save_data)
